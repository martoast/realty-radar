                ...
                <div class="space-y-4 w-100">
                  <div>
                    ...
                    <div class="mt-1 flex items-center space-x-2">
                      <input type="number" v-model="form.building_size_min" placeholder="Min" min="0" class="p-1 text-sm border rounded">
                      <span class="text-gray-500">-</span>
                      <input type="number" v-model="form.building_size_max" placeholder="Max" min="0" class="p-1 text-sm border rounded">
                    </div>
                  </div>
                  <div>
                    <p class="text-sm font-medium text-gray-700">Lot Size (sq ft)</p>
                    <div class="mt-1 flex items-center space-x-2">
                      <input type="number" v-model="form.lot_size_min" placeholder="Min" min="0" class="p-1 text-sm border rounded">
                      <span class="text-gray-500">-</span>
                      <input type="number" v-model="form.lot_size_max" placeholder="Max" min="0" class="p-1 text-sm border rounded">
                    </div>
                  </div>
                  <div>
                    <p class="text-sm font-medium text-gray-700">Year Built</p>
                    <div class="mt-1 flex items-center space-x-2">
                      <input type="number" v-model="form.year_built_min" placeholder="Min" min="0" class="p-1 text-sm border rounded">
                      <span class="text-gray-500">-</span>
                      <input type="number" v-model="form.year_built_max" placeholder="Max" min="0" class="p-1 text-sm border rounded">
                    </div>
                  </div>
                </div>
              </DisclosurePanel>
            ...
            <Disclosure v-slot="{ open }">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center h-5">
                        <input id="foreclosure" v-model="form.foreclosure" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
                    ...
                    <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="pre_foreclosure" v-model="form.pre_foreclosure" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
                    ...
                    <div class="mt-1 flex items-center space-x-2">
                        <input type="date" v-model="form.foreclosure_date_min" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                        <span class="text-gray-500">-</span>
                        <input type="date" v-model="form.foreclosure_date_max" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                    </div>
                    </div>
                    <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="auction" v-model="form.auction" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
                    ...
                    <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="reo" v-model="form.reo" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
              ...
              <DisclosurePanel class="px-4 pt-4 pb-2 text-sm text-gray-500">
                <div class="space-y-4 w-100">
                  <div>
                    ...
                    <div class="mt-1 flex items-center space-x-2">
                      <input type="date" v-model="form.last_sale_date_min" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                      <span class="text-gray-500">-</span>
                      <input type="date" v-model="form.last_sale_date_max" class="block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                    </div>
                  </div>
                  <div>
                    <p class="text-sm font-medium text-gray-700">Years Owned</p>
                    <div class="mt-1 flex items-center space-x-2">
                      <input type="number" v-model="form.years_owned_min" placeholder="Min" min="0" class="p-1 text-sm border rounded">
                      <span class="text-gray-500">-</span>
                      <input type="number" v-model="form.years_owned_max" placeholder="Max" min="0" class="p-1 text-sm border rounded">
                    </div>
                  </div>
                  <div>
                    <p class="text-sm font-medium text-gray-700">Last Sale Price ($)</p>
                    <div class="mt-1 flex items-center space-x-2">
                      <input type="number" v-model="form.last_sale_price_min" placeholder="Min" min="0" class="p-1 text-sm border rounded">
                      <span class="text-gray-500">-</span>
                      <input type="number" v-model="form.last_sale_price_max" placeholder="Max" min="0" class="p-1 text-sm border rounded">
                    </div>
                  </div>
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                      <input id="absentee_owner" v-model="form.absentee_owner" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
                  ...
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                      <input id="vacant" v-model="form.vacant" type="checkbox" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
